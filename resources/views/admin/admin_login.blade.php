...
<head>
        <title>Proposa Admin</title><meta charset="UTF-8" />
        ...
        <link href="font-awesome/css/fonts/backend_fonts/font-awesome.css" rel="stylesheet" />
        ...
        <div id="loginbox">
            <form id="loginform" class="form-vertical" method="post" action="{{ url('/admin') }}">
                ...
                <div class="form-actions">
                    ...
                    <span class="pull-right"><a type="submit" value="Login" class="btn btn-success" /> Login</a></span>
                </div>
            </form>
